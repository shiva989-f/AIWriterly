export const TemplateData = [
  ...
  },
  {
    ...
    aiPrompt:
      "Write a detailed blog post on the provided topic based on the provided outline. Format the content in a way that is suitable for a rich text editor, ensuring clear headings, subheadings, and paragraphs. Do not use Markdown or any unnecessary code blocks unless they are directly relevant to the content. Keep the output clean and structured for easy readability.",
    form: [
      {
  ...
  },
  {
    ...
    aiPrompt:
      "Give me Best SEO optimized high ranked 5 title ideas bullet wise only bases on keywords and outline and give me result in markdown format",
    form: [
      {
